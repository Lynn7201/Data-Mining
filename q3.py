...
# Cases and Testing 
import pandas as pd 
CMalaysia = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/cases_malaysia.csv') 
CState    = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/cases_state.csv')
clusters  = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/clusters.csv') 
TMalaysia = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/tests_malaysia.csv') 
TState    = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/tests_state.csvv')

# Healthcare 
pkrc          = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/pkrc.csv') 
hospital      = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/hospital.csv') 
icu           = pd.read_csv('/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/icu.csv')

# Deaths 
DMalaysia= pd.read_csv("/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/deaths_malaysia.csv") 
DState   = pd.read_csv("/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/epidemic/deaths_state.csv")

# Static data 
population    = pd.read_csv("/content/drive/MyDrive/Data-Mining-Assignment/covid19-public-main/population.csv")
...
for i, (X_train, X_test, y_train, y_test) in enumerate(regTrainSet): 
  print("\nState:", selectedState[i]) 
  rrf = regRF[i] 
  print("Accuracy of Random Forest on training set: {:.3f}".format(rrf.score(X_train, y_train))) 
  print("Accuracy of Random Forest on test set: {:.3f}".format(rrf.score(X_test, y_test))) 
  display(regRFDiff[i])
...
for i, (X_train, X_test, y_train, y_test) in enumerate(regTrainSet): 
  print("\nState:", selectedState[i]) 
  rdt = regDT[i] 
  print("Accuracy of Decision Tree on training set: {:.3f}".format(rdt.score(X_train, y_train))) 
  print("Accuracy of Decision Tree on test set: {:.3f}".format(rdt.score(X_test, y_test))) 
  display(regDTDiff[i])
...
for i, (X_train, X_test, y_train, y_test) in enumerate(classTrainSet): 
  print("\nState:", selectedState[i]) 
  crf = classRF[i] 
  print("Accuracy of Random Forest on training set: {:.3f}".format(crf.score(X_train, y_train))) 
  print("Accuracy of Random Forest on test set: {:.3f}".format(crf.score(X_test, y_test))) 
  print('Accuracy score of Random Forest: {:.3f}'.format(scoreRF[i])) 
...
for i, (X_train, X_test, y_train, y_test) in enumerate(classTrainSet): 
  print("\nState:", selectedState[i]) 
  cdt = classDT[i] 
  print("Accuracy of Decision Tree on training set: {:.3f}".format(cdt.score(X_train, y_train))) 
  print("Accuracy of Decision Tree on test set: {:.3f}".format(cdt.score(X_test, y_test))) 
  print('Accuracy score of Decision Tree: {:.3f}'.format(scoreDT[i])) 
